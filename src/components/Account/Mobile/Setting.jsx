...
const Setting = () => {
  return (
    <Stack gap={5} sx={{ width: '100%' }}>
      <Stack gap={0.7}>
        <Typography className={global.headingMobile} sx={{ marginBottom: '10px' }}>Notification Settings</Typography>
        <Option title="Alerts" sw={true} />
        <Option title="Notification" sw={true} />
      </Stack>

      <Stack gap={0.7}>
        <Typography className={global.headingMobile} sx={{ marginBottom: '10px' }}>App Version</Typography>

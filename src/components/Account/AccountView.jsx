                        ...
                        <Stack sx={{ width: '100%' }}>
                            ...
                            <Stack sx={{ marginTop: '20px', paddingLeft: '10px' }} gap={0.5}>
                                ...
                                <Typography className={styles.subhead}>
                                    ...
                                    <Typography className={styles.subvalue}>{userData.birthday || 'XX-XX-XXXX'}</Typography>
                                </Typography>
                            </Stack>
                        </Stack>
                        ...
                        <Stack sx={{ width: '100%' }}>
                            ...
                            {address ? (
                                <Stack sx={{ width: "53%", margin: "20px auto 10px", paddingLeft: '10px', alignItems: 'center' }} gap={0.5}>
                                    ...
                                    <Button variant='contained' className={global.button} style={{ fontSize: '13px', marginTop: '30px', padding: '5px 20px', width: 'fit-content', gap: '10px' }} onClick={() => setAddress(false)}>
